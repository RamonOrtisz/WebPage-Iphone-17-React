            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mb-16">
                    ...
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src="../../public/img/titanium-design.jpg" alt="iphone de titanium" />
                        <h3 className="font-bold mb-2 text-3xl">Titânio Premium</h3>
                        <p className="text-gray-300 font-medium">Estrutura em titânio de grau aeroespacial. O smartphone mais forte e leve.</p>
                    </div>
                    ...
                    <div className="bg-gray-900 p-8 rounded-3xl">
                        ...
                        <p className="text-gray-300 font-medium">O sistema operacional mais avançado do mundo com IA integrada.</p>
                    </div>

                </div>

                <div className="bg-gray-900 rounded-3xl p-12 font-medium" id="performance">
                    <h3 className="text-4xl font-bold mb-6 text-gradient">A18 Pro</h3>
                    <p className="text-gray-300 mb-6">O chip mais podedroso em um smartphone</p>
                ...
                <div className="text-center" id="camera">
                    <h3 className="text-4xl font-bold mb-10 mt-19">Sistema de câmera Pro avançado</h3>
                    <div className="grid grid-cols-3 gap-6">
                        <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 cursor-pointer transition-all duration-300">
                            <div className="text-4xl font-bold text-gradient mb-4 ">48MP</div>
