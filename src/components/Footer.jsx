            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="grid md:grid-cols-4 gap-8 mb-8">
                    {sections.map((section, index) => (
                        <div key={index}>
                            <h4 className="font-semibold mb-4 cursor-pointer" >{section.title}</h4>
                ...
                <div className="border-t border-gray-800 pt-6 ">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-gray-400">Copyright © 2023 Apple Inc. Todos os direitos reservados</p>
                        <div className="flex
                 gap-6 text- text-gray-400">
                            {buttonLinks.map((link, index) => (
                                <a key={index} href="#" className="hover:text-white text-sm">{link}</a>
                            ))}
                        </div>
                    </div>
